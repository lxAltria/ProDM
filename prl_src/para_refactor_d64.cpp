    ...
    case Dummy:
        if(!weighted){
            ...
            if(std::strcmp(data.c_str(), "Hurricane") == 0){
                ...
                refactor_velocities_1D_Dummy_WBP<T>(data_file_prefix, rdata_file_prefix, max_weight_for_vtot, approximator_eb, max_weight_for_temperature, block_size);
            }
        }
        break;
    case SZ3:
        if(!weighted){
            if(std::strcmp(data.c_str(), "Hurricane") == 0){
                ...
                refactor_velocities_3D_SZ3_WBP<T>(data, 500, 500, 500, data_file_prefix, rdata_file_prefix, approximator_eb);
            }
        }
        else{
            if(std::strcmp(data.c_str(), "Hurricane") == 0){
                ...
                refactor_velocities_1D_SZ3_WBP<T>(data_file_prefix, rdata_file_prefix, approximator_eb, max_weight_for_vtot, max_weight_for_temperature, block_size);
            }
            else if (std::strcmp(data.c_str(), "SCALE") == 0){
