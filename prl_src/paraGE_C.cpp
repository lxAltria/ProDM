...
int main(int argc, char ** argv){
	...
	global_tau = compute_global_value_range(C) * target_rel_eb;
    ...
    {
    case Dummy:
        total_retrieved_size = retrieve_C_Dummy<T>(rdata_file_prefix, tau, ebs, num_elements, weighted, local_max_act_error, local_max_est_error, weight_file_size, decrease_method);
        break;
    case SZ3:
        total_retrieved_size = retrieve_C_SZ3<T>(rdata_file_prefix, tau, ebs, num_elements, weighted, local_max_act_error, local_max_est_error, weight_file_size, decrease_method);
        break;
    case PMGARD:
        total_retrieved_size = retrieve_C_PMGARD<T>(rdata_file_prefix, tau, ebs, num_elements, weighted, local_max_act_error, local_max_est_error, weight_file_size, decrease_method);
        break;
    case GE:
        total_retrieved_size = retrieve_C_GE<T>(rdata_file_prefix, tau, ebs, num_elements, weighted, local_max_act_error, local_max_est_error, weight_file_size, decrease_method);
        break;
    default:
        break;
    }
