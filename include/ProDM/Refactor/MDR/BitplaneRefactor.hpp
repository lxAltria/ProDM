#ifndef PRODM_REFACTOR_MDR_BITPLANEREFACTOR_HPP
#define PRODM_REFACTOR_MDR_BITPLANEREFACTOR_HPP
...
namespace ProDM::MDR {
    ...
    class BitplaneRefactor : public concepts::RefactorInterface<T> {
    public:
        BitplaneRefactor(Decomposer decomposer, Interleaver interleaver, Encoder encoder, Compressor compressor, ErrorCollector collector, Writer writer)
