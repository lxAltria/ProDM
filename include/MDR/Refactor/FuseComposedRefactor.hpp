...
namespace MDR {
    ...
    public:
        FuseComposedRefactor(Decomposer decomposer, Interleaver interleaver, Encoder encoder, Compressor compressor, ErrorCollector collector, Writer writer)
        ...
        ~FuseComposedRefactor(){}

        void print() const {
            std::cout << "Fuse Composed refactor with the following components." << std::endl;
