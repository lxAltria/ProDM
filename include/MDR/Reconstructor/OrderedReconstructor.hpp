#ifndef _MDR_ORDERED_RECONSTRUCTOR_HPP
#define _MDR_ORDERED_RECONSTRUCTOR_HPP
...
namespace MDR {
    ...
    class OrderedReconstructor : public concepts::ReconstructorInterface<T> {
    public:
    ...
    private:        
        bool reconstruct(uint8_t target_level, const std::vector<uint8_t>& prev_level_num_bitplanes, bool progressive=true){
            ...
            if(current_level >= 0){
                if(current_level) {
                    data = decomposer.reposition_recompose_split_levels(level_buffers, reconstruct_dimensions, current_level, this->strides);
                }
            ...
            if(current_level >= 0){
                ...
                data = decomposer.reposition_recompose_split_levels(level_buffers, reconstruct_dimensions, target_level, this->strides);
            }
