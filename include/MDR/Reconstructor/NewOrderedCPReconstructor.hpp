...
namespace MDR {
    ...
    public:
        OrderedCPReconstructor(Decomposer decomposer, Interleaver interleaver, Encoder encoder, Compressor compressor, SizeInterpreter interpreter, Retriever retriever)
        ...
        T * reconstruct(double tolerance, int max_level=-1){
            ...
            size_t prev_coeff_bps = idx_coeff_bps;
