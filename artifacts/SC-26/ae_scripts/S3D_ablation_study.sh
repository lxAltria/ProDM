...
./build/test/two_modes_refactor $data_file "-d" 4 60 3 500 500 500 $refactor_file "-PerBit" "-eb" "-no_CP" > $tmp_file
...
./build/test/two_modes_refactor $data_file "-d" 4 60 3 500 500 500 $refactor_file "-PerBit" "-eb" "-CP" > $tmp_file
time=$(grep "Refactor_time" $tmp_file | head -n 1)
...
./build/test/two_modes_refactor $data_file "-d" 4 60 3 500 500 500 $refactor_file "-XOR" "-PSNR" "-no_CP" > $tmp_file
time=$(grep "Refactor_time" $tmp_file | head -n 1)
...
./build/test/two_modes_refactor $data_file "-d" 4 60 3 500 500 500 $refactor_file "-XOR" "-PSNR" "-CP" > $tmp_file
time=$(grep "Refactor_time" $tmp_file | head -n 1)
