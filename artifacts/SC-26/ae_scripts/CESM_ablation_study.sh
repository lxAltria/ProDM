...
./build/test/test_proaicd_refactor $data_file "-d" 3 60 3 26 1800 3600 $refactor_file "-PerBit" "-eb" "-no_CP" > $tmp_file
...
./build/test/test_proaicd_refactor $data_file "-d" 3 60 3 26 1800 3600 $refactor_file "-PerBit" "-eb" "-CP" > $tmp_file
time=$(grep "Refactor_time" $tmp_file | head -n 1)
...
./build/test/test_proaicd_refactor $data_file "-d" 3 60 3 26 1800 3600 $refactor_file "-XOR" "-PSNR" "-no_CP" > $tmp_file
time=$(grep "Refactor_time" $tmp_file | head -n 1)
